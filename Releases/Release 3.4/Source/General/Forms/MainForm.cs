...
namespace SushiNS
{
    public partial class MainForm : Form
    {
        ...
        private void addTreenodes()
        {
            ...
            addTreeviewNode(tnAdmin, "Security Reports", typeof(SushiNS.ActionSharepointSecurity), "security_report.png", "security_reports_h.png");
            addTreeviewNode(tnAdmin, "Profile Images Import", typeof(SushiNS.ActionProfileImages), "profile_image_import.png", "profile_image_import_h.png");
            addTreeviewNode(tnAdmin, "Backup", typeof(SushiNS.ActionBackup), "backup.png", "backup_h.png");
            addTreeviewNode(tnAdmin, "Restore", typeof(SushiNS.ActionRestore), "restore.png", "restore_h.png");
            addTreeviewNode(tnAdmin, "Email Test", typeof(SushiNS.ActionEmail), "email_test.png", "email_test_h.png");

            TreeNode tnLists = addTreeviewNode("Lists", null, "tvNavicon_reporting.gif", "tvNavicon_reporting.gif");
            addTreeviewNode(tnLists, "Copy A View", typeof(SushiNS.ActionCopyView), "copy_a_view.png", "copy_a_view_h.png");
            addTreeviewNode(tnLists, "Meta Data", typeof(SushiNS.ActionMetadata), "metadata.png", "metadata_h.png");
            addTreeviewNode(tnLists, "Bulk List Creation", typeof(SushiNS.ActionBulkListCreation), "bulk_list_creation.png", "bulk_list_creation_h.png");
            addTreeviewNode(tnLists, "Bulk Site Columns",typeof(SushiNS.ActionContentTypes), "bulk_site_creation.png", "bulk_site_creation_h.png");
            addTreeviewNode(tnLists, "Import Documents", typeof(SushiNS.ActionImportDocs), "import_doc.png", "import_doc_h.png");
            addTreeviewNode(tnLists, "Delete Old Documents", typeof(SushiNS.ActionDeleteOldDocs), "del.png", "del_h.png");

            TreeNode tnSites = addTreeviewNode("Sites", null, "bulk_site_creation.png", "bulk_site_creation_h.png");
            addTreeviewNode(tnSites, "Bulk Site Creation", typeof(SushiNS.ActionBulkSiteCreation), "bulk_site_creation.png", "bulk_site_creation_h.png");
            addTreeviewNode(tnSites, "Themes", typeof(SushiNS.ActionThemes), "themes.png", "themes_h.png");
            addTreeviewNode("Help & Settings", typeof(SushiNS.ActionSettings), "help_settings.png", "help_settings_h.png");
            
            #region keepcode
            //--addTreeviewNode(tnMore,"Bulk WebPart Customize", "SushiNS.ActionBulkWebPartCustomization", null,null);
            #endregion
        }
        ...
        private void displayVersionAndAccountId()
        {
            ...
            GlobalVars.MyAppVersion = n.Version.ToString(2);
        ...
        {
            pbHelp.Image = SushiNS.Properties.Resources.help_d;
        }
        ...
        private void pbHelp_MouseLeave(object sender, EventArgs e)
        {
            ...
            pbHelp.Image = SushiNS.Properties.Resources.help;
        }
        private void pbHelp_MouseHover(object sender, EventArgs e)
        {
            pbHelp.Image = SushiNS.Properties.Resources.help_h;
        }
